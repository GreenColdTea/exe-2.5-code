function onStepHit()
	if curStep == 1440 then
		...
		noteTweenX('bfnotemove1', 4, 465, 1, 'quartInOut')
		noteTweenX('bfnotemove2', 5, 575, 1, 'quartInOut')
		noteTweenX('bfnotemove3', 6, 685, 1, 'quartInOut')
		noteTweenX('bfnotemove4', 7, 795, 1, 'quartInOut')	
	end
	if curStep == 1488 then
		noteTweenX('bfnotemove1', 4, 235, 1, "quartInOut")
		noteTweenX('bfnotemove2', 5, 395, 1, "quartInOut")
		noteTweenX('bfnotemove3', 6, 805, 1, "quartInOut")
		noteTweenX('bfnotemove4', 7, 965, 1, "quartInOut")	
	end
	...
	if curStep == 1824 then
		noteTweenX('bfnotemove1', 4, 415, 0.01, 'quartInOut')
		noteTweenX('bfnotemove2', 5, 535, 0.01, 'quartInOut')
		noteTweenX('bfnotemove3', 6, 645, 0.01, 'quartInOut')
		noteTweenX('bfnotemove4', 7, 755, 0.01, 'quartInOut')	
	end
	if getPropertyFromClass('ClientPrefs', 'downScroll') == true and curStep == 1825 then	
		noteTweenY("bfnotemovedown1", 4, 565, 0.01, "quartInOut")
		noteTweenY("bfnotemovedown2", 5, 565, 0.01, "quartInOut")
		noteTweenY("bfnotemovedown3", 6, 565, 0.01, "quartInOut")
		noteTweenY("bfnotemovedown4", 7, 565, 0.01, "quartInOut")
